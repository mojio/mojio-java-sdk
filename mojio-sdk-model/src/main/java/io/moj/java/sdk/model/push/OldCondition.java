...
public class OldCondition {
     ...
     * {@code String.format(OldCondition.TIME_FORMAT, days, hours, minnutes, seconds, milliseconds)}
     */
    ...
    public OldCondition.Position getPosition() {
        return Position;
    }

    public void setPosition(OldCondition.Position position) {
        Position = position;
    }
    ...
    public boolean equals(Object o) {
        ...
        OldCondition condition = (OldCondition) o;
     ...
     * @return
     */
    public static OldCondition onPropertyChanged(String property) {
        OldCondition c = new OldCondition(Type.PROPERTY_CHANGED);
     ...
     * @return
     */
    public static OldCondition onThreshold(String property, Position position, Double min, Double max) {
        OldCondition c = new OldCondition(Type.THRESHOLD);
        c.setProperty(property);
     ...
     * @see #TIME_FORMAT
     */
    public static OldCondition debounce(Integer minDataPoints, String delay) {
        OldCondition c = new OldCondition(Type.DEBOUNCE);
     ...
     * @return
     */
    public static OldCondition debounce(Integer minDataPoints, int days, int hours, int minutes,
                                        int seconds) {
     ...
     * @return
     */
    public static OldCondition minDataPoints(Integer minDataPoints) {
     ...
     * @return
     */
    public static OldCondition delay(String delay) {
     ...
     *                broadcast. Added with the other time properties.
     */
    public static OldCondition delay(int days, int hours, int minutes, int seconds) {
     ...
     * @return
     */
    public static OldCondition throttle(String timeProperty, String window) {
        OldCondition c = new OldCondition(Type.THROTTLE);
     ...
     * @return
     */
    public static OldCondition throttle(String timeProperty, int days, int hours, int minutes, int seconds) {
     ...
     * @return
     */
    public static OldCondition throttle(int days, int hours, int minutes, int seconds) {
